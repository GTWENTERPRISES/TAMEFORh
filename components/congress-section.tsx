          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-[450px] rounded-2xl overflow-hidden border-4 border-[#3d9a8b] shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/20">
                    ...
                    <p className="text-[#3d9a8b] text-sm font-medium">Gestión y Ciencia Forestal Sostenible</p>
                  </div>
                </div>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-[#3d9a8b] font-medium uppercase tracking-wider text-sm">Evento Principal</span>
              </div>
              ...
              <p className="text-white/90 mb-8 leading-relaxed text-lg">
                Únete al evento más importante del sector forestal en Los Ríos. Conferencias magistrales, 
                talleres prácticos y networking profesional con expertos nacionales e internacionales.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-white text-lg">20-22 de Abril, 2026</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full bg-[#3d9a8b]/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-white text-lg">Quevedo, Los Ríos, Ecuador</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full bg-[#3d9a8b]/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="text-sm text-white/70 uppercase tracking-wider">Participantes</p>
                    <p className="font-semibold text-white text-lg">Más de 500 profesionales esperados</p>
                  </div>
                </div>
              </div>
